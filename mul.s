...
# The result is 1024 bit. ceil(1024/29) = 36. ceil(36/8) = 5.
...
#.set ACC7, %zmm7
#.set ACC8, %zmm8
# The inputs are 512 bit. ceil(512/29) = 18. ceil(18/8) = 3.
.set A0, %zmm9
.set A1, %zmm10
.set A2, %zmm11
.set A3, %zmm12
...
mul1024_avx512:
    ...
    # shift. We have a total of 18 digits, therefore we multipy A in 8
